...
class RTL_SDR_rcv(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "RTL_SDR_rcv", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("RTL_SDR_rcv")
        ...
        self.settings = Qt.QSettings("GNU Radio", "RTL_SDR_rcv")
        ...
        self._rfGain_range = Range(0, 50, 1, 10, 200)
        self._rfGain_win = RangeWidget(self._rfGain_range, self.set_rfGain, "RF Gain (db)", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._rfGain_win, 1, 0, 1, 10)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 10):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._freq_range = Range(87.9e6, 107.9e6, 200e3, 102.1e6, 200)
...
def main(top_block_cls=RTL_SDR_rcv, options=None):
